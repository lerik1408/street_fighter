...
export async function getFighterInfo(fighterId) {
  ...
  const moreInfo = await fighterService.getFighterDetails(fighterId);
  if (!fighterDetailsMap.get(moreInfo._id)) {
    fighterDetailsMap.set(moreInfo._id, moreInfo);
  }

  return fighterDetailsMap.get(moreInfo._id);
}
